...
//  
//  @author     Philippe Decaudin, Sebastian Lipponer
...
#include "MiniSDL20.h" // a subset of SDL.h needed to compile TwEventSDL.c
...
//  The following code is an attempt to handle SDL 2.0 events.
...
int TW_CALL TwEventSDL20(const void *sdlEvent)
{
    ...
    case SDL_KEYDOWN:
        if( event->key.keysym.sym )
        {
            ...
            {
            case SDLK_BACKSPACE:  key = TW_KEY_BACKSPACE;  break;
            case SDLK_TAB:        key = TW_KEY_TAB;        break;
            case SDLK_CLEAR:      key = TW_KEY_CLEAR;      break;
            case SDLK_RETURN:     key = TW_KEY_RETURN;     break;
            case SDLK_PAUSE:      key = TW_KEY_PAUSE;      break;
            case SDLK_ESCAPE:     key = TW_KEY_ESCAPE;     break;
            case SDLK_DELETE:     key = TW_KEY_DELETE;     break;
            case SDLK_UP:         key = TW_KEY_UP;         break;
            case SDLK_DOWN:       key = TW_KEY_DOWN;       break;
            case SDLK_RIGHT:      key = TW_KEY_RIGHT;      break;
            case SDLK_LEFT:       key = TW_KEY_LEFT;       break;
            case SDLK_INSERT:     key = TW_KEY_INSERT;     break;
            case SDLK_HOME:       key = TW_KEY_HOME;       break;
            case SDLK_END:        key = TW_KEY_END;        break;
            case SDLK_PAGEUP:     key = TW_KEY_PAGE_UP;    break;
            case SDLK_PAGEDOWN:   key = TW_KEY_PAGE_DOWN;  break;
            default:
    ...
    case SDL_WINDOWEVENT:
        ...
        // Do not set 'handled', SDL_WINDOWEVENT_RESIZED may be also processed
